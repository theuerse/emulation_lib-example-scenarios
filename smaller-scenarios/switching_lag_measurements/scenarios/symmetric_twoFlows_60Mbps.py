...
nb1 = NetworkBlock("./blocks/symmetric_60Mbps")
nb1.setNodes([n0, n1])
nb1.selectInterval(1000)

nb2 = NetworkBlock("./blocks/symmetric_60Mbps")
nb2.setNodes([n2, n1])
nb2.selectInterval(1000)

emu.addNetworkBlocks([nb1, nb2])

udperf_app0 = UdperfApp(n1, n0, 0.0, 12, 60000, 6000, 6001)
udperf_app2 = UdperfApp(n1, n2, 0.0, 12, 60000, 6000, 6002)  # own-Ports must be unique on the same node!
...
emu.setName('symmetric_twoFlows60Mbps')
