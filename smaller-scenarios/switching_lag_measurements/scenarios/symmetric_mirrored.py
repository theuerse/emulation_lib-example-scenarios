...
from emulation_lib.preprocessing.mirror_file import MirrorFile

emu_duration = 30  # seconds
...
nb1.addPreprocessingStep(MirrorFile(False))
...
emu.setName('symmetric_mirrored')
